...
function seed(db = require('./db').data()) {
  ...
  const defaultEmployees = [
    ...
    // Ghabbour Auto Demo Employee
    {
      id: 'emp_gb_1',
      tenantId: 'ghabbour',
      name: 'Yasser Mansour',
      nationalId: '28909201234568',
      employeeCode: 'GB-30114',
      factory: 'abu_rawash',
      department: 'Bus Assembly Line 2',
      position: 'Senior Assembly Specialist',
      supervisor: 'Ashraf Tolba',
      phone: '+20 114 455 6677',
      vacationBalance: 15,
      pinHash: null,
      tokenVersion: 1,
      active: true,
    ...
    // Talaat Moustafa Group Demo Employee
    {
      id: 'emp_tmg_1',
      tenantId: 'tmg',
      name: 'Mostafa Nour',
      nationalId: '29202021234569',
      employeeCode: 'TMG-55021',
      factory: 'madinaty',
      department: 'City Operations & Facilities',
      position: 'Facilities Supervisor',
      supervisor: 'Sameh Helmy',
      phone: '+20 128 899 1122',
      vacationBalance: 21,
      pinHash: null,
      tokenVersion: 1,
      active: true,
    ...
    // Gulf Industrial Corp Demo Employee
    {
      id: 'emp_gic_1',
  ...
  const defaultLoans = [
    ...
    {
      id: 'loan_sample_gic_1',
      tenantId: 'gulf_industrial',
      referenceNumber: 'LN-2026-5532',
      employeeId: 'emp_gic_1',
      type: 'emergency_advance',
      amount: 3000,
      ...
      notes: 'سلفة طارئة بالريال السعودي - الخليج للصناعات',
      currency: 'SAR',
      status: 'active',
      createdAt: Date.now(),
      approvedAt: Date.now(),
      repaymentSchedule: [
        { installmentNumber: 1, period: 'October 2026', amount: 1500, status: 'pending', deductedAt: null },
        { installmentNumber: 2, period: 'November 2026', amount: 1500, status: 'pending', deductedAt: null },
      ],
    },
  ];
