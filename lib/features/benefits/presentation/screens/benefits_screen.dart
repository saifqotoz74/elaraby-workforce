...
class _BenefitsScreenState extends State<BenefitsScreen> {
  ...
  final List<_CategoryFilter> _categories = [
    _CategoryFilter(
        label: AppLocale.tr('ben_cat_featured'), icon: Icons.auto_awesome),
    _CategoryFilter(
        label: AppLocale.tr('ben_cat_supermarkets'),
        icon: Icons.shopping_cart_outlined),
    _CategoryFilter(
        label: AppLocale.tr('ben_cat_health'),
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              return _buildTripCard(
                                title: t.title,
                                subtitle: 'Company - subsidized • ${t.price}',
