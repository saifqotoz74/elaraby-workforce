...
void main() {
  ...
  group('Auth Screens Functional Tests', () {
    ...
    testWidgets(
        'GetStartedScreen renders language switch and get started button',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('NationalIdScreen validates 14 digits and enables button',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('OtpScreen renders 6 digits inputs and handles input',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      await tester.pumpWidget(
          createTestApp(const OtpScreen(nationalId: '30607301402992')));
      await tester.pumpAndSettle();
    ...
    testWidgets('ProfileConfirmationScreen displays worker info',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  group('Services Screens Functional Tests', () {
    testWidgets('VacationBalanceScreen renders metrics and leave breakdown',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'RequestLeaveScreen calculates duration and validates submission',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('SalarySlipScreen renders salary elements and deductions',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets(
        'RaiseConcernScreen renders category picker and anonymous toggle',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('YourRequestsScreen renders filter tabs and requests',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('EmployeeDataScreen renders official company records',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  group('Profile & Dialogs Functional Tests', () {
    ...
    testWidgets('ChangePinScreen renders step current PIN title',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      expect(find.text(AppLocale.tr('change_pin_step_current_title')),
          findsOneWidget);
    });

    testWidgets('HelpSupportScreen renders support contacts and FAQs',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('UpdateDialog renders force update and optional update modes',
        (tester) async {
      tester.view.physicalSize = const Size(800, 1200);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
