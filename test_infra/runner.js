...
const TIERS = [
  {
    ...
    targetMin: 175,
    desc: 'Opaque-box feature coverage across 35 requirements (Features 1-35)',
  },
  {
    tier: 2,
    ...
    targetMin: 175,
    desc: 'Extreme values, zero states, security injections, schema boundaries & edge coordinates (B1-B35)',
  },
  {
    tier: 3,
    ...
    targetMin: 30,
    desc: 'Pairwise and cascading multi-domain interactions (INT-1 to INT-30)',
  },
  {
    tier: 4,
    ...
    targetMin: 15,
    desc: '15 end-to-end multi-tenant enterprise and industrial user journeys (SCENARIO 1-15)',
  },
];
...
async function main() {
  ...
  console.log(' Target Suite: Tiers 1-4 (Coverage Target: >= 395 Tests)');
  console.log('================================================================================\n');
